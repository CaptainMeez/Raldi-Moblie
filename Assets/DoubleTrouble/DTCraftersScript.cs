...
public class DTCraftersScript : MonoBehaviour
{
	...
	private void OnTriggerEnter(Collider other)
	{
		if (other.tag == "Player" & this.angry)
		{
			...
			this.player.position = new Vector3(5f, this.player.position.y, 12f);
			...
			FindObjectOfType<BaldiCharacterManager>().DespawnCrafters();
		}
	}
