...
public class FirstLoadFailsafe : MonoBehaviour
{
    void Start()
    {
        if (PlayerPrefs.GetFloat("GameFirstLoad") == 0)
        {
            WBG.WindowsError.Message_Box("The Raldi's Crackhouse cosmetic system wasn't loaded correctly.\nThis may be caused by premature loading of late-game scenes, or other methods of accessing scenes earlier than intended.\n\nReloading Raldi's Crackhouse to prevent any further technical errors from occuring...", "Raldi's Crackhouse", "OK");
...
/// <summary>
        ...
        public static string Message_Box(string text, string caption, string type)
        {
            try
            {
