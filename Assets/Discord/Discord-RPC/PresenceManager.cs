...
namespace DiscordPresence
{
    ...
    public class PresenceManager : MonoBehaviour
    {
        ...
        public void UpdateRpc(string detail, 
        string state = null, 
        long start = -1, 
        long end = -1, 
        ...
        bool instance*/)
        {
            UpdatePresence(detail,state,start,end,largeKey,largeText, smallKey, smallText, partyId, size,max, match, join, spectate);
            ClearPresence();
        ...
        public static void UpdatePresence(string detail, 
        string state = null, 
        long start = -1, 
        long end = -1, 
        string largeKey = null,
